...
function getDepartmentInfo(department_name, records) {
    ...
    return {
        work_dept_cd: department.department_cd,
        work_dept_name: department.department_name,
        work_company_cd: department.company_cd,
        work_company_name: department.company_name,
        work_company_short: department.company_short_name
    };
}
