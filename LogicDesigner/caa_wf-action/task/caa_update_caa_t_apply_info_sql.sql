...
SET
    ...
    , cntr_dept_cd = /*cntr_dept_cd*/                                           -- 管理組織コード
    , receive_user_cd = /*receive_user_cd*/                                     -- 担当者：ユーザコード
    , receive_employee_no = /*receive_employee_no*/                             -- 担当者：社員番号
    , receive_user_name = /*receive_user_name*/                                 -- 担当者：氏名
    , receive_post_cd = /*receive_post_cd*/                                     -- 担当者：役職コード
    , receive_post_name = /*receive_post_name*/                                 -- 担当者：役職名
    , receive_dept_cd = /*receive_dept_cd*/                                     -- 契約部署コード
    , receive_dept_name = /*receive_dept_name*/                                 -- 契約部署名
    , receive_company_cd = /*receive_company_cd*/                               -- 契約会社コード
    , receive_company_name = /*receive_company_name*/                           -- 契約会社名
    , receive_company_short = /*receive_company_short*/                         -- 契約会社略称
    , work_dept_cd = /*work_dept_cd*/                                           -- 就業先部署コード
    , work_dept_name = /*work_dept_name*/                                       -- 就業先部署名
    , work_company_cd = /*work_company_cd*/                                     -- 就業先会社コード
    , work_company_name = /*work_company_name*/                                 -- 就業先会社名
    , work_company_short = /*work_company_short*/                               -- 就業先会社略称
    ...
    , attend_count_other = /*attend_count_other*/                               -- 出社回数（その他）
    , work_location = /*work_location*/                                         -- 勤務地
    , work_location_other = /*work_location_other*/                             -- 勤務地（その他）
    , apply_count = /*apply_count*/                                             -- 申請人数
    , doc_management_no = /*doc_management_no*/                                 -- 稟議番号（基本契約書）
    , indv_doc_management_no = /*indv_doc_management_no*/                       -- 稟議番号（個別契約書）
    , file_memo = /*file_memo*/                                                 -- ファイル備考
    , memo = /*memo*/                                                           -- 備考
    , receive_dept_mod_flg = /*receive_dept_mod_flg*/                           -- 契約部署：修正フラグ
    , receive_mod_flg = /*receive_mod_flg*/                                     -- 受入担当者：修正フラグ
    , work_mod_flg = /*work_mod_flg*/                                           -- 就業先：修正フラグ
    ...
    , doc_management_no_mod_flg = /*doc_management_no_mod_flg*/                 -- 稟議番号（基本契約書）：修正フラグ
    , indv_doc_management_no_mod_flg = /*indv_doc_management_no_mod_flg*/       -- 稟議番号（個別契約書）：修正フラグ
    , upd_date = now()                                                          -- 更新日時
